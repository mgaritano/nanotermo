...
name: heco_e
---
  “Helize-haril” kateari $\pm q$ kargak erantsi dizkiogu mutur banatan. Hori dela eta, katean barrena $\vert\mathbf{p}\vert = ql$ momentu dipolar elektrikoa azaleratuko da, non $l$ katearen luzera den. Halaber, helize eta haril unitate bakoitzari $\alpha$ polarizabilitatea esleituko diogu. Bada, $\mathbf{E}$ eremu elektriko ezarriz gero ($\mathbf{E} \parallel \mathbf{p}$), bi faktore horiek ekarpen energetikoa izango dute, segidan zehaztuko dugun legez.
```
